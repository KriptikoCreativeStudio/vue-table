'use strict';Object.defineProperty(exports,'__esModule',{value:true});function _interopDefault(e){return(e&&(typeof e==='object')&&'default'in e)?e['default']:e}var Vue=_interopDefault(require('vue')),axios=_interopDefault(require('axios')),qs=_interopDefault(require('qs')),Vuex=require('vuex'),Vuex__default=_interopDefault(Vuex),VueDraggable=_interopDefault(require('vuedraggable'));function getCjsExportFromNamespace (n) {
...
};Vue.directive('filter-column', columnFilter);var directives=/*#__PURE__*/Object.freeze({__proto__:null});var directives$1 = getCjsExportFromNamespace(directives);var script = {
...
var __vue_component__$2 = /*#__PURE__*/normalizeComponent({
  ...
  data: function data() {
    return {
      items: [],
      lang: commonjsRequire("../resources/lang/".concat(this.locale, ".json")),
      totalItems: 0
    };
  },
  props: {
...
var __vue_module_identifier__$3 = "data-v-0f86753a";
/* functional template */
...
}, __vue_inject_styles__$3, __vue_script__$3, __vue_scope_id__$3, __vue_is_functional_template__$3, __vue_module_identifier__$3, false, undefined, undefined, undefined);var paginationStorageName = "vue_table_".concat(window.location.pathname, "_page");
